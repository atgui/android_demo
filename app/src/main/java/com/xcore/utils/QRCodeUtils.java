...
import com.xcore.utils.zxing.BarcodeFormat;
import com.xcore.utils.zxing.BitMatrix;
import com.xcore.utils.zxing.CharacterSetECI;
import com.xcore.utils.zxing.EncodeHintType;
import com.xcore.utils.zxing.ErrorCorrectionLevel;
import com.xcore.utils.zxing.QRCodeWriter;
import com.xcore.utils.zxing.WriterException;

import java.util.Hashtable;

public class QRCodeUtils {
    public static void qrCode(String url, ImageView imageView, int width, int height){
       Bitmap qrCode= createQRCodeBitmap("Hello World!", width);
